...
(function (TypeGuards) {
    ...
    const userInputNull = '';
    const storedData = userInputNull || 'DEFAULT'; // Produces 'DEFAULT' on console log in the case of empty string and null/undefined
    clog("Empty string produces -> ", storedData);
    // If we wanted the empty string to work however, we could use the null coalescing operator which will only use 'DEFAULT' if the value is
    // literally null or undefined
    const storedData2 = userInputNull !== null && userInputNull !== void 0 ? userInputNull : 'DEFAULT';
    clog("Empty string produces -> ", storedData2);
...
console.log(admin2);
//# sourceMappingURL=typeguards-namespace-nullcoalescing.js.map