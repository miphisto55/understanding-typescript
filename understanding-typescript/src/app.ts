...
function addRegular(n1: number, n2: number = 5) {       // can also pass in default values for parameters
    return n1 + n2;
}

// arrow function way of defining a function, these all do the same thing
const addArrow1 = (n1: number, n2: number) => n1 + n2;
const addArrow2 = (n1: number, n2: number) => {
    n1 + n2;
}
const addArrow3 = (n1: number, n2: number) => {
    return n1 + n2;
}
